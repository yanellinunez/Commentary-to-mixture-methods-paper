...
#pdf("./Figures/lasso_summary.pdf")
summary_data_lasso %>%
  group_by(chem) %>%
  ggplot(aes(x = chem)) +
   geom_hline(yintercept = 0, color = "black") +
  geom_jitter(aes(y = beta_lasso, color = Group), shape=16, size = 1, position=position_jitter(width = .2)) +
...
<<<<<<< HEAD
  geom_col(aes(y = number_nonzero/4000, fill = Group), width = 0.8, position ="identity", alpha = 0.006) +
=======
  geom_col(aes(y = number_nonzero/4000, fill = Group), width = 0.8, position ="identity", alpha = 0.005) +
>>>>>>> 0fd4f5e4eddf65665618107701058fd7b255d794
