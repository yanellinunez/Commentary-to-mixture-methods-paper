...
write.csv(summary_data_lasso, "summary_data_lasso")
...
summary_data_lasso %>%
  group_by(chem) %>%
  ggplot(aes(x = chem)) +
  geom_jitter(aes(y = beta_lasso, color = Group), shape=16, size = 1, alpha = 1,  position=position_jitter(height = 0.0008, width = .2)) +
