...
## Multiply by 2^31 to get randomly drawn seeds
...
repeat_knot_seed <- tibble(seed = random_seeds) %>%
...
get_data_viz <- function(row) {
  ...
  modeltoplot      <- repeat_knot_seed[row, 3][[1]][[1]]   ## name of model object
...
repeat_knot_seed <- repeat_knot_seed %>% unnest_wider(plot_dat)
...
# 
# repeat_knot_seed$uni_plot
# 
# # Save files
# # file_names <- paste0("pred.resp.univar", repeat_knot_seed$seed, ".pdf")
# # map2(paste0("pred.resp.univar", repeat_knot_seed$seed, ".pdf"), repeat_knot_seed$uni_plot, ggsave)
# 
# ##########################################################################################################################
...
# 
# repeat_knot_seed$bivar_plot
# 
# # Save files
# # file_names <- paste0("pred.resp.bivar.levels", repeat_knot_seed$seed, ".pdf")
# # map2(paste0("pred.resp.bivar.levels", repeat_knot_seed$seed, ".pdf"), repeat_knot_seed$bivar_plot, ggsave)
# 
# ##########################################################################################################################
...
# 
# repeat_knot_seed$overall_plot
# 
# # Save files
# # file_names <- paste0("risks.overall", repeat_knot_seed$seed, ".pdf")
# # map2(paste0("risks.overall", repeat_knot_seed$seed, ".pdf"), repeat_knot_seed$overall_plot, ggsave)
# 
# ##########################################################################################################################
...
# 
# repeat_knot_seed$int_plot
# 
# # Save files
# # file_names <- paste0("risks.singvar", repeat_knot_seed$seed, ".pdf")
# # map2(paste0("risks.singvar", repeat_knot_seed$seed, ".pdf"), repeat_knot_seed$risks.singvar, ggsave)
# 
# ##########################################################################################################################
...
# 
# # Save files
# # file_names <- paste0("risk.int", repeat_knot_seed$seed, ".pdf")
# # map2(paste0("risk.int", repeat_knot_seed$seed, ".pdf"), repeat_knot_seed$int_plot2, ggsave)
