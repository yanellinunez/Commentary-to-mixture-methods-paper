...
get_pips(repeat_knot_seed[1,3][[1]][[1]])
...
repeat_knot_seed <- repeat_knot_seed %>% unnest_wider(plot_dat) %>% select(-fits)

save(repeat_knot_seed, file = "bkmr_repeat_10_knots.RData")

load("bkmr_repeat_10_knots.RData")
